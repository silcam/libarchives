...
class DocumentTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create document_type" do
    assert_difference('DocumentType.count') do
      post document_types_url, params: { document_type: { document_type: @document_type.document_type, document_type_french: @document_type.document_type_french } }
    end
  ...
  test "should update document_type" do
    patch document_type_url(@document_type), params: { document_type: { document_type: @document_type.document_type, document_type_french: @document_type.document_type_french } }
